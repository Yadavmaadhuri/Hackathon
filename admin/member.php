...
<style>
    ...
    #teamTable {
        table-layout: fixed;
        /* equal column width calculation */
        width: 100%;
    }
...
<div class="main">
    ...
    <div class="table-container">
        ...
        <div id="editModal"
            ...
            <div
                style="background:#fff; margin:5% auto; padding:20px; width:500px; max-height:80; overflow-y:auto; border-radius:10px; position:relative;">
                ...
                <form id="editForm" method="POST" action="member_edit.php" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="number" class="form-control mb-2" id="mSymbol" name="symbol_no"
                                placeholder="Symbol No." required>
                            <div id="mSymbolError" class="error"></div>
                        </div>

                        <div class="col-6">
                            <label class="mb-1">Name</label>
                            <input type="text" class="form-control mb-2" id="mName" name="member_name"  maxlength="100"
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="email" class="form-control mb-2" id="mEmail" name="email"  maxlength="255" placeholder="Email"
                                required>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control mb-2" id="mPhone" name="phone" placeholder="Phone"
                                required>
                    ...
                    <div class="row">
                        <div>
                            ...
                            <input type="text" class="form-control mb-2" id="mCollege"  maxlength="100" name="college"
        ...
        <script>
            ...
            document.getElementById("editForm").addEventListener("submit", function (e) {
                ...
                const collegeValid = collegePattern.test(mCollege.value);
