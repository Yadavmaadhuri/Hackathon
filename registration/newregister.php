...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="memberForm">
            <input type="text" class="form-control mb-2" id="mSymbol" placeholder="Symbol No." required>
  ...
  <script>
    ...
    document.getElementById("mSymbol").addEventListener("input", function () {
      document.getElementById("mSymbolError").textContent = symbolPattern.test(this.value) ? "" : "Must be 12 digits.";
    });
    ...
    function addMember() {
      ...
      row.innerHTML = `
        ...
        <td>${phone}</td>
        <td>
          <input type="file" name="photo_${memberCount - 1}" class="form-control mb-1" required />
          <input type="file" name="admit_${memberCount - 1}" class="form-control mb-1" required />
